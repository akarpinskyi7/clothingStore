				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					switch ( $column_id ) {
						...
						case 'label':
							...
							$value .= '</label>';
							$add_class = 'product-list';
							break;
						case 'price':
							$value = $grouped_product_child->get_price_html() . wc_get_stock_html( $grouped_product_child );
							$add_class = 'product-price';
							break;
						default:
							$value = '';
							$add_class = '';
					...
					echo '<td class="' . $add_class . ' woocommerce-grouped-product-list-item__' . esc_attr( $column_id ) . '">' . apply_filters( 'woocommerce_grouped_product_list_column_' . $column_id, $value, $grouped_product_child ) . '</td>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
